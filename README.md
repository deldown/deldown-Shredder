...
![dds](https://raw.githubusercontent.com/NotAMonkeIRL/NotAMonkeIRL/refs/heads/main/files/pictures/deldown/deldownShredder.png)
...
```shell
git clone https://github.com/deldown/deldown-Shredder/
```
